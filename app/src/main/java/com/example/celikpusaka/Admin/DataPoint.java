...
class DataPoint {
    ...
    public DataPoint(String name, String gender, String jumharta, String pengurusan, String suami, String isteri, String bapa, String ibu, String anakPerempuan, String anakLelaki, String bakiharta, String hartaIbu, String hartaBapa, String hartaIsteri, String hartaSuami, String hartaAnakL, String hartaAnakP) {
        this.name = name;
        this.gender = gender;
