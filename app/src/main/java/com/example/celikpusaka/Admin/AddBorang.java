...
public class AddBorang extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_borang);

        edittext=findViewById(R.id.editText);
        btn=findViewById(R.id.btn);
        backBtn=findViewById(R.id.btnback);

        storageReference = FirebaseStorage.getInstance().getReference("Borang");
        ...
        backBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(AddBorang.this,ViewBorangAdmin.class);
    ...
    private void uploadPDFFileFirebase(Uri data) {
        ...
        reference.putFile(data)
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                Intent intent = new Intent(AddBorang.this, ViewBorangAdmin.class);
                Toast.makeText(AddBorang.this,"Borang telah disimpan", Toast.LENGTH_LONG).show();
