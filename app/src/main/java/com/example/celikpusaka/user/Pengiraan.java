...
public class Pengiraan {

    String name,  gender;

    String jumharta, pengurusan;
    ...
    public Pengiraan(String name, String gender, String jumharta, String pengurusan, String suami, String isteri, String bapa, String ibu, String anakPerempuan, String anakLelaki, String bakiharta, String hartaIbu, String hartaBapa, String hartaIsteri, String hartaSuami, String hartaAnakL, String hartaAnakP) {
        this.name = name;
        this.gender = gender;
        this.jumharta = jumharta;
    ...
    public String getJumharta() {
        return jumharta;
    }

    public void setJumharta(String jumharta) {
        this.jumharta = jumharta;
    }

    public String getPengurusan() {
        return pengurusan;
    }

    public void setPengurusan(String pengurusan) {
        this.pengurusan = pengurusan;
    }
